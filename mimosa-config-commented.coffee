# THE FOLLOWING IS A FULLY COMMENTED VERSION OF THE mimosa-config.coffee
# WITH ALL OF THE MOST RECENT DEFAULTS. THIS FILE IS MEANT FOR REFERENCE
# ONLY.
...
exports.config = {
  ...
  ###
  modules: ["server","require","minify","lint","live-reload","testem-require","bower"]
